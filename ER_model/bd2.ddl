...
ALTER TABLE courses_lectures ADD CONSTRAINT courses_lectures_pk PRIMARY KEY ( courses_id, lecturers_id );
...
ALTER TABLE student_spec ADD CONSTRAINT student_spec_pk PRIMARY KEY ( spec_id, students_id );
...
CREATE UNIQUE INDEX users_idx ON users ( lecturers_id ASC );

ALTER TABLE users ADD CONSTRAINT users_pk PRIMARY KEY ( user_id );

ALTER TABLE classes ADD CONSTRAINT classes_courses_fk FOREIGN KEY ( courses_id ) REFERENCES courses ( course_id );
ALTER TABLE classes ADD CONSTRAINT classes_students_fk FOREIGN KEY ( students_id ) REFERENCES students ( student_id );
...
ALTER TABLE courses_lectures ADD CONSTRAINT courses_lectures_lecturers_fk FOREIGN KEY ( lecturers_id ) REFERENCES lecturers ( user_id );
...
ALTER TABLE grades ADD CONSTRAINT grades_lecturers_fk FOREIGN KEY ( lecturers_id ) REFERENCES lecturers ( lecture_id );
ALTER TABLE grades ADD CONSTRAINT grades_students_fk FOREIGN KEY ( students_id ) REFERENCES students ( student_id );
...
ALTER TABLE student_spec ADD CONSTRAINT student_spec_students_fk FOREIGN KEY ( students_id ) REFERENCES students ( user_id );

ALTER TABLE users ADD CONSTRAINT users_lecturers_fk FOREIGN KEY ( lecturers_id ) REFERENCES lecturers ( lecture_id );
